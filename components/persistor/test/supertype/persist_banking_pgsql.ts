...
describe('typescript tests: Banking from pgsql Example persist_banking_pgsql', function () {
    ...
    it ('can log in a closed loop', function () {
        ...
        sam.amorphic.logger.startContext({name: '@havenlife-public/supertype'});
        ...
        console.log(output);
        var result = '(__amorphicContext={"name":"@havenlife-public/supertype"}foo="bar1")(__amorphicContext={"name":"@havenlife-public/supertype","permFoo":"permBar1"}permFoo="permBar1"foo="bar2")(__amorphicContext={"name":"@havenlife-public/supertype"}foo="bar3")(__amorphicContext={"name":"@havenlife-public/supertype","permFoo":"childFoo"}permFoo="childFoo"foo="bar4")(__amorphicContext={"name":"@havenlife-public/supertype"}foo="bar5")(__amorphicContext={"name":"supertype2"}foo="bar6"woopie={"yea":true,"oh":"2010-11-11T00:00:00.000Z"})(__amorphicContext={"name":"supertype2"}foo="bar6"woopie={"yea":true,"oh":"2010-11-11T00:00:00.000Z"})';
