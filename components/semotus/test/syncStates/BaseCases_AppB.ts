...
import {resultsAppB} from './results/BaseCases';
...
describe('Basic Test Cases: Initial Object Synchronization', function () {
    ...
    describe('Scope is +', function () {
        it.only('With app B restriction and state = second will only return B and non-appA objects which do not have syncState = first', async function () {
