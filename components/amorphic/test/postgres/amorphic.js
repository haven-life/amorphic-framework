...
RemoteObjectTemplate = require('@haventech/semotus').default._createObject();
...
let clientController, serverController;
...
describe('First Group of Tests', function () {
    ...
    before(function() {
        setServerController = function (controller) {
