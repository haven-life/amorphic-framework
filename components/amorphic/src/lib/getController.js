...
import { getSessionCache } from './session/getSessionCache.js';
import { decompressSessionData } from './session/decompressSessionData.js';
import { amorphicStatic } from '../index.js';
 ...
 * @returns {*}
 */
export async function getController(path, controllerPath, initObjectTemplate, expressSession, objectCacheExpiration, sessionStore,
    ...
    if (config.appConfig.templateMode === 'typescript') {
        injectTemplatesIntoCurrentSession(amorphicStatic, persistableSemotableTemplate);
    }
