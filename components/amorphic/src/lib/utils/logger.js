 ...
 */
export function log(level, sessionId, logObjectParam, logLevel) {
    if (level > logLevel) {
        return;
    }
 ...
 */
export function getLoggingContext(app, context) {
    context = context || {};
 ...
 */
export function setupLogger(logger, path, context, applicationConfig) {
