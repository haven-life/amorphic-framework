...
export async function controller(objectTemplate, getTemplate) {
    ...
    var Controller = objectTemplate.create('Controller', {
        ...
        serverInit: function () {
            ...
            globalThis.setServerController(serverController);
        },
        ...
        clientInit: function () {
            ...
            globalThis.setClientController(clientController);
        ...
        postServerCall: function () {
            ...
            //return;
            var dirtCount = 0;
			const serverController = globalThis.window.serverController;
